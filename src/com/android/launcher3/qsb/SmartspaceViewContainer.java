...
import com.android.launcher3.NestLauncher;
import com.android.launcher3.NestLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        NestLauncher launcher = (NestLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        NestLauncherModelDelegate delegate = (NestLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        NestLauncher launcher = (NestLauncher) ActivityContext.lookupContext(getContext());
