...
public class NestLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "NestLauncherModelDelegate";
    ...
    @Inject
    public NestLauncherModelDelegate(@ApplicationContext Context context,
